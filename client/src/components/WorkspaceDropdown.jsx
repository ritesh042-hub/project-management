...
function WorkspaceDropdown() {
  ...
  // Sync current workspace with Clerk
  useEffect(() => {
  ...
  // Use userMemberships.data if available, otherwise fallback to workspaces
  const displayWorkspaces = userMemberships?.data?.length
